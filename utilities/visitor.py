...
class Visitor:
    ...
    def ArrayType(self, ast: asts.ArrayType) -> None:
        self.fn(ast)
        self.TypeAST(ast.element_type_ast)

    def BoolType(self, ast: asts.BoolType) -> None:
        self.fn(ast)

    def IntType(self, ast: asts.IntType) -> None:
        self.fn(ast)

    def VoidType(self, ast: asts.VoidType) -> None:
        self.fn(ast)
